...
class Config:
    def __init__(self):
        self.hostname = "ise.lab.local"
        self.nodename = "ernakh wesocketclient"
        self.password = "ItwpHXZS25moYjk8"
        self.description = ""

        self.clientcert = "ernakh.lab.local_192.168.133.30.cer"
        self.clientkey = "ernakh.lab.local_192.168.133.30.key"
        self.clientkeypassword = "Cisco123"
        self.isecert = "CertificateServicesRootCA-ise_.cer"
