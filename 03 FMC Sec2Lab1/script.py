...
def ftd_generate_token():
    auth_url='https://192.168.111.20/api/fmc_platform/v1/auth/generatetoken'

    res = requests.post(auth_url, headers={'Authentication': 'Basic Authentication'}, auth=('administrator', 'Pass123'), verify=False)
...
def ftd_register_device(appl, auth_token):
    reg_url = 'https://192.168.111.20/api/fmc_config/v1/domain/e276abec-e0f2-11e3-8169-6d9ed49b625f/devices/devicerecords'

    access_policy = {'id': '005056B4-B76F-0ed3-0000-236223201282', 'type': 'AccessPolicy'}
